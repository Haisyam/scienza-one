					...
					<div class="mb-6 md:mb-0">
						<a href="#" class="flex items-center">
							<img
								src="/LogoTKJ3.png"
								alt=""
								className="h-[3rem] w-[3rem] right-1 relative rounded-full brightness-200"
							/>
					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/mhmdkhrzmi/?hl=id" class="hover:underline">
										@mhmdkhrzmi
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/_scienza.one/?hl=id" class="hover:underline ">
										Instagram
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Website Scieza One | Di Kelola Oleh Siswa XI IPA 1
						</p>
					</div>
				</div>
			</div>
